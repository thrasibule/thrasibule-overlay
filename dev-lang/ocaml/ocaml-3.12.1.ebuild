...
src_unpack() {
	unpack ${A}
	cd "${S}"
	epatch "${WORKDIR}/patches/010_all_execstacks.patch"
	epatch "${WORKDIR}/patches/020_all_configure.patch"
	epatch "${WORKDIR}/patches/030_all_automagic.patch"
	epatch "${WORKDIR}/patches/040_all_yaccldflags.patch"
	epatch "${WORKDIR}/patches/050_all_objinfoldflags.patch"
}
