// $ANTLR 3.3 March 12, 2011 17:33:47 org/antlr/gunit/swingui/parsers/ANTLRv3.g 2011-03-18 09:45:44
...
public class ANTLRv3Parser extends Parser {
    ...
    public final ANTLRv3Parser.grammarDef_return grammarDef() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: tokensSpec, DOC_COMMENT, rule, optionsSpec, id, attrScope, action
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    // $ANTLR start "action"
    // org/antlr/gunit/swingui/parsers/ANTLRv3.g:125:1: action : '@' ( actionScopeName '::' )? id ACTION -> ^( '@' ( actionScopeName )? id ACTION ) ;
    public final ANTLRv3Parser.action_return action() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: actionScopeName, 72, ACTION, id
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    // org/antlr/gunit/swingui/parsers/ANTLRv3.g:130:1: actionScopeName : ( id | l= 'lexer' -> ID[$l] | p= 'parser' -> ID[$p] );
    ...
    public final ANTLRv3Parser.rule_return rule() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: optionsSpec, ruleAction, id, exceptionGroup, altList, rt, arg, ruleScopeSpec
            // token labels: arg, rt
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    // org/antlr/gunit/swingui/parsers/ANTLRv3.g:179:1: ruleAction : '@' id ACTION -> ^( '@' id ACTION ) ;
                ...
                case 1 :
                    ...
                    switch (alt40) {
                        case 1 :
                            ...
                            // AST REWRITE
                            // elements: id, ebnfSuffix, labelOp, atom
        ...
        try {
            ...
            switch (alt54) {
                ...
                case 4 :
                    ...
                    // AST REWRITE
                    // elements: op, RULE_REF, RULE_REF, RULE_REF, RULE_REF, arg, arg, op
                    // token labels: arg, op
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
    ...
    // $ANTLR start "ebnf"
    // org/antlr/gunit/swingui/parsers/ANTLRv3.g:284:1: ebnf : block (op= '?' -> ^( OPTIONAL[op] block ) | op= '*' -> ^( CLOSURE[op] block ) | op= '+' -> ^( POSITIVE_CLOSURE[op] block ) | '=>' -> {gtype==COMBINED_GRAMMAR &&\n\t\t\t\t\t Character.isUpperCase($rule::name.charAt(0))}? ^( SYNPRED[\"=>\"] block ) -> SYN_SEMPRED | -> block ) ;
        ...
        try {
            ...
            switch (alt63) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: preds, rew, rew2, predicated, last
                    // token labels: rew2
    ...
    // org/antlr/gunit/swingui/parsers/ANTLRv3.g:409:1: rewrite_template : ( id lp= '(' rewrite_template_args ')' (str= DOUBLE_QUOTE_STRING_LITERAL | str= DOUBLE_ANGLE_STRING_LITERAL ) -> ^( TEMPLATE[$lp,\"TEMPLATE\"] id rewrite_template_args $str) | rewrite_template_ref | rewrite_indirect_template_head | ACTION );
    ...
    // org/antlr/gunit/swingui/parsers/ANTLRv3.g:436:1: rewrite_template_ref : id lp= '(' rewrite_template_args ')' -> ^( TEMPLATE[$lp,\"TEMPLATE\"] id rewrite_template_args ) ;
    ...
    // org/antlr/gunit/swingui/parsers/ANTLRv3.g:442:1: rewrite_indirect_template_head : lp= '(' ACTION ')' '(' rewrite_template_args ')' -> ^( TEMPLATE[$lp,\"TEMPLATE\"] ACTION rewrite_template_args ) ;
